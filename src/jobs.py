...
class JobManager:
    ...
    def init_workers(self):
        ...
        for i in range(len(self.unemployed)):
            ...
            self.logs.append([4, '{} was chosen to be a {}.'.format(
                self.unemployed[i].name, chosen)])
    ...
    def assign_workers(self):
        ...
        for worker in self.unemployed:
            ...
            self.logs.append(
                [4, '{} was chosen to be a {}.'.format(worker.name, chosen)])
    ...
    def tick_farmers(self):
        ...
        for n in self.farmers:
            ...
            self.logs.append(
                [4, '{} harvests {} crops.'.format(n.name, final)])
    ...
    def tick_hunters(self):
        ...
        for n in self.hunters:
            ...
            if r.randint(0, 1) > 0:
                ...
                self.logs.append(
                    [4, '{} hunts and brings back {} food'.format(n.name, final)])
                ...
                self.logs.append(
                    [4, '{} hunts and catches nothing.'.format(n.name)])
